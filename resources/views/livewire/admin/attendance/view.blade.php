<div>
    <div class="px-6 py-4">
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex items-center space-x-3">
                <button wire:click="exportDateAttendance" 
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900">{{ $dateStats->total_students ?? 0 }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-green-600">{{ $dateStats->present_count ?? 0 }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-red-600">{{ $dateStats->absent_count ?? 0 }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-yellow-600">{{ $dateStats->late_count ?? 0 }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-blue-600">{{ $dateStats->excused_count ?? 0 }}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div class="flex items-end">
                    <button wire:click="$set('searchStudent', ''); $set('filterStatus', '')" 
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200">
                ...
                <p class="text-sm text-gray-600">Detailed attendance information for each student</p>
            </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach($attendanceRecords as $record)
                                <tr class="hover:bg-gray-50 transition-colors">
                                            ...
                                            <div class="flex-shrink-0 h-10 w-10">
                                                @if($record->student->photo)
                                                    <img class="h-10 w-10 rounded-full object-cover" 
                                                         src="{{ asset('storage/' . $record->student->photo) }}" 
                                                         alt="{{ $record->student->name }}">
                                                @else
                                                    <div class="h-10 w-10 rounded-full bg-gray-300 flex items-center justify-center">
                                                        <span class="text-sm font-medium text-gray-700">
                                                            {{ substr($record->student->name, 0, 2) }}
                                                        </span>
                                                    </div>
                                                @endif
                                            </div>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">{{ $record->student->roll_no }}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">
                                            {{ $record->admission->batch->course->name ?? 'N/A' }}
                                        </div>
                                        <div class="text-sm text-gray-500">
                                            Batch: {{ $record->admission->batch->name ?? 'N/A' }}
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
