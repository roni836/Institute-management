        ...
        <div class="border-t pt-4">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-3">
                <div>
                    ...
                    @error('tution_fee')<p class="text-xs text-red-600">{{ $message }}</p>@enderror
                </div>
                <div>
                    ...
                    @error('admission_fee')<p class="text-xs text-red-600">{{ $message }}</p>@enderror
                </div>
                <div>
                    <label class="text-xs">Exam Fee (₹)</label>
                    <input type="number" step="0.01" min="0" class="w-full border rounded p-2" wire:model="exam_fee">
                    @error('exam_fee')<p class="text-xs text-red-600">{{ $message }}</p>@enderror
                </div>
                <div>
                ...
                <div>
                    ...
                    @error('other_fee')<p class="text-xs text-red-600">{{ $message }}</p>@enderror
                </div>
            </div>
        </div>
