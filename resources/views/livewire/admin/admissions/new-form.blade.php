<div data-step="{{ $step ?? 1 }}" data-mode="{{ $mode ?? 'full' }}" data-same="{{ $same_as_permanent ? 1 : 0 }}"
    x-data="{
                ...
                <div class="flex justify-center mt-3">
                    <div class="flex items-center space-x-3">
                        <div id="step1-indicator"
                            class="step-indicator flex items-center justify-center w-8 h-8 rounded-full font-bold text-sm"
                            :class="{ 'active': step === 1, 'completed': step > 1 }">1</div>
                        <div class="w-12 h-1 bg-primary-300"></div>
                        <div id="step2-indicator"
                            class="step-indicator flex items-center justify-center w-8 h-8 rounded-full font-bold text-sm"
                            :class="{ 'active': step === 2 }">2</div>
                    </div>
                </div>
                    ...
                    <div id="step1" class="form-section" x-show="step === 1" x-cloak>
                        ...
                        <div class="mb-3 p-3 border border-primary-100 rounded bg-primary-50">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                                <div>
                                    ...
                                    <input wire:model="admission_date" type="date" name="admission_date" required
                                ...
                                <div>
                                    ...
                                    <select wire:model.live="stream" name="stream" required
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                                ...
                                <div>
                                    <label class="block text-xs font-medium text-gray-700 mb-1">Academic Session
                                        *</label>
                                    <select wire:model.live="academic_session" name="academic_session" required
                                ...
                                <div>
                                    ...
                                    <select wire:model="course_id" wire:change="onCourseChange" name="course" required
                                        class="w-full px-3 py-1.5 text-sm border border-gray-300 rounded focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                                        <option value="">Select Course</option>
                                        @foreach ($courses as $course)
                                            <option value="{{ $course->id }}">{{ $course->name }}
                                                (₹{{ number_format($course->net_fee, 2) }})</option>
                                        @endforeach
                                    </select>
                                    @error('course_id')
                                        <span class="text-red-500 text-sm">{{ $message }}</span>
                                ...
                                <div>
                                    ...
                                    <select wire:model="batch_id" wire:change="recalculate" name="batch" required
                                        class="w-full px-3 py-1.5 text-sm border border-gray-300 rounded focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                        ...
                        <div class="mb-3 p-3 border border-primary-100 rounded bg-primary-50">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input wire:model="father_name" type="text" name="father_name"
                                        class="w-full px-3 py-1.5 text-sm border border-gray-300 rounded focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                                    @error('father_name')
                                        <span class="text-red-500 text-sm">{{ $message }}</span>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <input wire:model="mother_name" type="text" name="mother_name"
                                        class="w-full px-3 py-1.5 text-sm border border-gray-300 rounded focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                                    @error('mother_name')
                                        <span class="text-red-500 text-sm">{{ $message }}</span>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <input wire:model="whatsapp_no" type="tel" name="whatsapp_no"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                                    @error('whatsapp_no')
                                        <span class="text-red-500 text-sm">{{ $message }}</span>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <input wire:model="dob" type="date" name="dob"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                                    @error('dob')
                                        <span class="text-red-500 text-sm">{{ $message }}</span>
                                    @enderror
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Father
                                        Occupation</label>
                                    <input wire:model="father_occupation" type="text" name="father_occupation"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Mother
                                        Occupation</label>
                                    <input wire:model="mother_occupation" type="text" name="mother_occupation"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                        ...
                        <div class="mb-3 p-3 border border-primary-100 rounded bg-primary-50">
                            ...
                            <div class="mb-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4" x-data="addressDropdown('perm')"
                                    x-init="init()">
                                    <div class="md:col-span-2">
                                        <label class="block text-sm font-medium text-gray-700 mb-2">Address Line 1
                                            *</label>
                                        <input wire:model="address_line1" type="text" name="address_line1"
                                            required
                                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                                        @error('address_line1')
                                            <span class="text-red-500 text-sm">{{ $message }}</span>
                                    ...
                                    <div class="md:col-span-2">
                                        <label class="block text-sm font-medium text-gray-700 mb-2">Address Line
                                            2</label>
                                        <input wire:model="address_line2" type="text" name="address_line2"
                                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                                        @error('address_line2')
                                            <span class="text-red-500 text-sm">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-2">State/Union
                                            Territory</label>
                                        <select wire:model="state" x-model="selectedState" @change="onStateChange()"
                                            name="state"
                                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                                    ...
                                    <div>
                                        ...
                                        <select wire:model="district" x-model="selectedDistrict"
                                            @change="onDistrictChange()" name="district"
                                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                                    ...
                                    <div>
                                        ...
                                        <select wire:model="city" x-model="selectedCity" @change="onCityChange()"
                                            name="city"
                                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                                    ...
                                    <div>
                                        ...
                                        <input wire:model="pincode" type="text" name="pincode"
                            ...
                            <div class="mb-4">
                                <div class="flex items-center mb-3">
                                    <input wire:model.live="same_as_permanent" type="checkbox" id="sameAddress"
                                        class="mr-2">
                                    <label for="sameAddress" class="text-sm font-medium text-gray-700">Correspondence
                                        Address same as Permanent Address</label>
                                </div>

                                <div x-show="!same_as_permanent" x-cloak>
                                    <h4 class="text-lg font-medium text-gray-700 mb-3">Correspondence Address</h4>
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4" x-data="addressDropdown('corr')"
                                        x-init="init()">
                                        <div class="md:col-span-2">
                                            <label class="block text-sm font-medium text-gray-700 mb-2">Address Line 1
                                                *</label>
                                            <input wire:model="corr_address_line1" x-ref="corr_address_line1"
                                                :disabled="same_as_permanent" type="text"
                                                name="corr_address_line1"
                                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                                        ...
                                        <div class="md:col-span-2">
                                            <label class="block text-sm font-medium text-gray-700 mb-2">Address Line
                                                2</label>
                                            <input wire:model="corr_address_line2" x-ref="corr_address_line2"
                                                :disabled="same_as_permanent" type="text"
                                                name="corr_address_line2"
                                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                                        ...
                                        <div>
                                            <label class="block text-sm font-medium text-gray-700 mb-2">State/Union
                                                Territory</label>
                                            <select wire:model="corr_state" x-model="selectedState"
                                                @change="onStateChange()" name="corr_state"
                                        ...
                                        <div>
                                            ...
                                            <select wire:model="corr_district" x-model="selectedDistrict"
                                                @change="onDistrictChange()" name="corr_district"
                                                :disabled="!selectedState || same_as_permanent"
                                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                                                <option value="">Select District</option>
                                                <template x-for="d in districts" :key="d.name">
                                                    <option :value="d.name" x-text="d.name"></option>
                                        ...
                                        <div>
                                            <label class="block text-sm font-medium text-gray-700 mb-2">City</label>
                                            <select wire:model="corr_city" x-model="selectedCity"
                                                @change="onCityChange()" name="corr_city"
                                                :disabled="!selectedDistrict || same_as_permanent"
                                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                                                <option value="">Select City</option>
                                                <template x-for="c in cities" :key="c">
                                                    <option :value="c" x-text="c"></option>
                                        ...
                                        <div>
                                            <label class="block text-sm font-medium text-gray-700 mb-2">Pin
                                                Code</label>
                                            <input wire:model="corr_pincode" x-ref="corr_pincode"
                                                :disabled="same_as_permanent" type="text" name="corr_pincode"
                                                inputmode="numeric" pattern="[0-9]{6}" maxlength="6"
                                                oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 6);"
                                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                                            @error('corr_pincode')
                                        ...
                                        <div>
                                            <label class="block text-sm font-medium text-gray-700 mb-2">Country</label>
                                            <input wire:model="corr_country" x-ref="corr_country"
                                                :disabled="same_as_permanent" type="text" name="corr_country"
                                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                                                value="India">
                                            @error('corr_country')
                                                <span class="text-red-500 text-sm">{{ $message }}</span>
                        ...
                        <div class="mb-3 p-3 border border-primary-100 rounded bg-primary-50">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select wire:model="student_status" name="student_status"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                                ...
                                <div>
                                    ...
                                    <input wire:model="school_name" type="text" name="school_name"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                                ...
                                <div>
                                    ...
                                    <input wire:model="school_address" type="text" name="school_address"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                                ...
                                <div>
                                    ...
                                    <select wire:model="board" name="board"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                        ...
                        <div class="mb-3 p-3 border border-primary-100 rounded bg-primary-50">
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                <div class="bg-white border border-primary-100 rounded-lg p-4">
                                    ...
                                    <div class="space-y-5">
                                        <div>
                                            <label class="block text-sm font-medium text-gray-700 mb-2">Student
                                                Photo</label>
                                            <input type="file" wire:model="photo_upload" accept="image/*"
                                                class="w-full text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500" />
                                            <div wire:loading wire:target="photo_upload"
                                                class="text-xs text-primary-600 mt-1">Uploading photo...</div>
                                            @error('photo_upload')
                                                <span class="text-red-500 text-xs">{{ $message }}</span>
                                            @enderror
                                            <div class="mt-3">
                                                ...
                                                @elseif($this->existingPhotoUrl)
                                                    <img src="{{ $this->existingPhotoUrl }}" alt="Uploaded photo"
                                                        class="h-32 w-32 object-cover rounded-lg shadow" />
                                                @else
                                        ...
                                        <div>
                                            <label class="block text-sm font-medium text-gray-700 mb-2">Aadhaar
                                                Card</label>
                                            <input type="file" wire:model="aadhaar_upload" accept="image/*,.pdf"
                                                class="w-full text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500" />
                                            <div wire:loading wire:target="aadhaar_upload"
                                                class="text-xs text-primary-600 mt-1">Uploading Aadhaar...</div>
                                            @error('aadhaar_upload')
                                                <span class="text-red-500 text-xs">{{ $message }}</span>
                                            @enderror
                                            <div class="mt-3 space-y-2 text-sm text-gray-700">
                                                @if ($aadhaar_upload)
                                                    <p class="font-medium">
                                                        {{ $aadhaar_upload->getClientOriginalName() }}</p>
                                                    @if (str_contains($aadhaar_upload->getMimeType(), 'image'))
                                                        <img src="{{ $aadhaar_upload->temporaryUrl() }}"
                                                            alt="Aadhaar preview"
                                                            class="h-32 w-32 object-cover rounded-lg shadow" />
                                                    @endif
                                                @elseif($this->existingAadhaarUrl)
                                                    <a href="{{ $this->existingAadhaarUrl }}" target="_blank"
                                                        rel="noopener" class="text-primary-600 underline">
                                                        View
                                                        Aadhaar{{ $this->existingAadhaarFilename ? ' (' . $this->existingAadhaarFilename . ')' : '' }}
                                                    </a>
                                                @else
                                                    <p class="text-xs text-gray-500">No Aadhaar document uploaded yet.
                                                    </p>
                                                @endif
                                            </div>
                                        </div>
                                ...
                                <div class="bg-white border border-primary-100 rounded-lg p-4">
                                    ...
                                    <div class="grid grid-cols-1 gap-3">
                                        <div>
                                            <label class="block text-sm font-medium text-gray-700 mb-1">Additional
                                                Module 1</label>
                                            <input type="text" wire:model.defer="module1" name="module1"
                                        ...
                                        <div>
                                            <label class="block text-sm font-medium text-gray-700 mb-1">Additional
                                                Module 2</label>
                                            <input type="text" wire:model.defer="module2" name="module2"
                                                placeholder="Optional"
                                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                                            @error('module2')
                                                <span class="text-red-500 text-xs">{{ $message }}</span>
                                        ...
                                        <div>
                                            <label class="block text-sm font-medium text-gray-700 mb-1">Additional
                                                Module 3</label>
                                            <input type="text" wire:model.defer="module3" name="module3"
                                                placeholder="Optional"
                                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                                            @error('module3')
                                                <span class="text-red-500 text-xs">{{ $message }}</span>
                                        ...
                                        <div>
                                            <label class="block text-sm font-medium text-gray-700 mb-1">Additional
                                                Module 4</label>
                                            <input type="text" wire:model.defer="module4" name="module4"
                                                placeholder="Optional"
                                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                                            @error('module4')
                                                <span class="text-red-500 text-xs">{{ $message }}</span>
                                        ...
                                        <div>
                                            <label class="block text-sm font-medium text-gray-700 mb-1">Additional
                                                Module 5</label>
                                            <input type="text" wire:model.defer="module5" name="module5"
                                                placeholder="Optional"
                                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                                            @error('module5')
                                                <span class="text-red-500 text-xs">{{ $message }}</span>
                                    ...
                                    <div class="mt-4">
                                        <label class="flex items-center">
                                            <input type="checkbox" wire:model.live="id_card_required" name="idCard"
                                                class="mr-2">
                            ...
                            <div class="mb-3 p-3 bg-white rounded">
                                ...
                                @php
                                    ...
                                    if ($selectedStudentId && !empty($foundStudents)) {
                                        $selectedStudent = collect($foundStudents)->firstWhere(
                                            'id',
                                            $selectedStudentId,
                                        );
                                    }
                                    ...
                                    if ($selectedStudent) {
                                        $admissionIdentifier =
                                            data_get($selectedStudent, 'student_uid') ??
                                            (data_get($selectedStudent, 'enrollment_id') ?? 'Existing Student');
                                    } elseif ($stream) {
                                    ...
                                    $contactSummary = [
                                        ...
                                        [
                                            'icon' => '📘',
                                            'label' => 'Course',
                                            'value' => data_get($selected_course, 'name', '—'),
                                        ],
                                        [
                                            'icon' => '📅',
                                            'label' => 'Session',
                                            'value' => $academic_session ?: ($session ?: '—'),
                                        ],
                                        ...
                                        [
                                            'icon' => '🗓️',
                                            'label' => 'Batch Type',
                                            'value' => data_get($selected_batch, 'batch_name', '—'),
                                        ],
                                        [
                                            'icon' => '🆔',
                                            'label' => 'Admission Number',
                                            'value' => $admissionIdentifier,
                                        ],
                                        [
                                            'icon' => '🏷️',
                                            'label' => 'Category',
                                            'value' => $category ? strtoupper($category) : '—',
                                        ],
                                    ];
                                @endphp
                            ...
                            <div class="mb-3 p-3 bg-primary-600 text-white rounded">
                                ...
                                <div class="flex items-center space-x-4 mt-2">
                                    <label class="inline-flex items-center">
                                        <input wire:model.live="applyGst" type="radio" name="gstOption"
                                            value="1" class="form-radio h-5 w-5 text-white border-white">
                                        <span class="ml-2 text-white">Apply 18% GST</span>
                                    </label>
                                    <label class="inline-flex items-center">
                                        <input wire:model.live="applyGst" type="radio" name="gstOption"
                                            value="0" class="form-radio h-5 w-5 text-white border-white" checked>
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div class="flex justify-between items-center p-3 border rounded-lg">
                                            ...
                                            <div class="flex space-x-4">
                                                <label class="inline-flex items-center">
                                                    <input wire:model.live="mode" type="radio" name="paymentMode"
                                                        value="full" class="form-radio h-4 w-4 text-primary-600"
                                                        checked>
                                        ...
                                        <div class="p-3 border rounded-lg">
                                            <div class="mb-3">
                                                ...
                                                <div class="grid grid-cols-2 gap-2">
                                                    <div>
                                                        ...
                                                        <select wire:model="discount_type" wire:change="recalculate"
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="flex items-center">
                                                            <input wire:model="discount_value"
                                                                wire:change="recalculate" type="number"
                                                                min="0" step="0.01"
                                                                class="w-full px-2 py-1 text-sm text-right border rounded"
                                                                placeholder="0.00">
                                                            <span
                                                                class="ml-1 text-xs font-medium">{{ $discount_type == 'percentage' ? '%' : '₹' }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="flex justify-between items-center">
                                                ...
                                                <div class="flex items-center">
                                                    <span
                                                        class="text-sm font-medium">₹{{ number_format($discount, 2) }}</span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div x-show="mode === 'installment'" class="bg-white border rounded-lg p-4">
                                            ...
                                            <div class="space-y-3">
                                                <div class="flex items-center justify-between">
                                                    <label class="text-sm font-medium text-gray-700">Select No.
                                                        Installment</label>
                                                    <div class="flex items-center space-x-2">
                                                        <input wire:model="installments" type="number"
                                                            min="2" max="12"
                                                            class="w-16 px-2 py-1 border border-gray-300 rounded text-center"
                                                            placeholder="3">
                                                        <button type="button" wire:click="recalculate"
                                                            class="px-3 py-1 bg-primary-500 text-white text-xs rounded hover:bg-primary-600">
                                                            Generate
                                                        </button>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="mt-4">
                                                        <div class="bg-gray-50 rounded-lg p-3">
                                                            @foreach ($plan as $index => $p)
                                                                <div
                                                                    class="flex items-center justify-between py-2 {{ $index > 0 ? 'border-t border-gray-200' : '' }}">
                                                                    <span
                                                                        class="text-sm font-medium">{{ $p['no'] }}</span>
                                                                    <div class="flex items-center space-x-2">
                                                                        <input type="date"
                                                                            value="{{ $p['due_on'] }}"
                                                        ...
                                                        @error('plan')
                                                            <div class="text-red-500 text-xs mt-1">{{ $message }}
                                                            </div>
                                                        @enderror
                                                    </div>
                                                @endif
                                            ...
                                            @if ($selected_course)
                                                <div class="space-y-2">
                                                    <div class="flex justify-between py-2">
                                                        ...
                                                        <span
                                                            class="font-medium">{{ number_format($selected_course->tution_fee ?? 18000, 0) }}</span>
                                                    </div>

                                                    <div class="flex justify-between py-2">
                                                        <span class="text-sm text-gray-700">Other Fee</span>
                                                        <span
                                                            class="font-medium">{{ number_format($selected_course->other_fee ?? 17000, 0) }}</span>
                                                    </div>

                                                    <div class="flex justify-between py-2">
                                                        <span class="text-sm text-gray-700">Discount</span>
                                                        <span
                                                            class="font-medium text-red-600">{{ number_format($discount ?? 0, 2) }}</span>
                                                    </div>

                                                    <div class="flex justify-between py-2">
                                                        <span class="text-sm text-gray-700">Late Fine + Pre
                                                            charge</span>
                                                        <span
                                                            class="font-medium">{{ number_format($lateFee ?? 0, 2) }}</span>
                                                    </div>

                                                    <hr class="border-gray-200 my-2">

                                                    <div class="flex justify-between py-2">
                                                        <span class="text-sm font-medium text-gray-700">Taxable
                                                            Amt.</span>
                                                        <span
                                                            class="font-semibold">{{ number_format($subtotal ?? 35000, 2) }}</span>
                                                    </div>
                                                    ...
                                                    @if ($applyGst)
                                                        <div class="flex justify-between py-2">
                                                            ...
                                                            <span
                                                                class="font-medium">{{ number_format($gstAmount ?? 6300, 0) }}</span>
                                                        </div>
                                                    @endif
                                                    ...
                                                    <div class="flex justify-between py-3 bg-primary-50 px-3 rounded">
                                                        ...
                                                        <span
                                                            class="text-lg font-bold text-primary-600">{{ number_format($fee_total ?? 41300, 0) }}</span>
                                                    </div>
                                                </div>
                                            @else
                                                <div class="text-center py-8">
                                                    <p class="text-gray-500">Please select a course to view fee details
                                                    </p>
                                                </div>
                                            @endif
                                        </div>
